...
public class ClientPlayer3 extends Canvas implements Runnable, KeyListener {
	...
	// Ball info
		...
		public ClientPlayer3() throws Exception {
			requestInformation();
		...
		private void movement() {
			...
			if (moveLeft && c3XPos > 0) {
				c3XPos -= speed;
			}

			if (moveRight &&  ((c3XPos + pHeight4 < getWidth())) ) {
				c3XPos += speed;
			}
		...
		private void tick() throws IOException {
    		...
    		String sentence = "3," + Integer.toString(c3XPos)+","+"0";
		     ...
		     if((PingPong.players==3||PingPong.players==4)){
				...
				if(PingPong.players==4){
					...
					DatagramPacket sendPacket3 = new DatagramPacket(sendData3, sendData3.length, IPAddress2, port2);
